...
/* package hotel-analysis-1.0.0.0 */
#ifndef VERSION_hotel_analysis
#define VERSION_hotel_analysis "1.0.0.0"
#endif /* VERSION_hotel_analysis */
#ifndef MIN_VERSION_hotel_analysis
#define MIN_VERSION_hotel_analysis(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_hotel_analysis */
...
#define CURRENT_COMPONENT_ID "hotel-analysis-1.0.0.0-inplace-hotel-analysis"
